...
//     * 弹幕批量更新
//     */
//    route("/AGE-API/barrageBatchUpdate") {
//        post {
//            val barrageEntity = call.receive<BarrageEntity>()
//            val isSuccess = dao.insertOrUpdateBarrage(
//                barrageEntity.animeId,
//                barrageEntity.exCode,
//                barrageEntity.barrageList
//            )
//            call.respond(if (isSuccess) "更新成功" else "更新失败")
//        }
//    }
